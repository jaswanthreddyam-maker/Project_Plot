                ...
                <div className="bg-[#1a1a1a] border border-[#262626] rounded-xl p-6">
                    ...
                    <form onSubmit={handleSave} className="flex gap-4 items-end">
                        ...
                        <button
                            ...
                            className="bg-black text-white dark:bg-white dark:text-black border border-black dark:border-white hover:opacity-90 px-6 py-2.5 rounded-lg text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed h-[42px] save-btn"
                        >
